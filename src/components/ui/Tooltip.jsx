...
export function Tooltip({ text, content, children, className }) {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block group-focus-within:block group-focus:block w-max max-w-xs z-50 pointer-events-none"
        aria-hidden="true"
      >
